			...
			<c:forEach var="imgs" items="${list}" varStatus="i">
				...
				<div class='mak' style="display: flex;">
					<a data-img="${imgs.i_url}"><img src="${imgs.i_url}"
						...
						<button id="like${imgs.i_seq}" class="gallery_items_like" value="${imgs.i_seq}">
		 ...
		 $(document).ready(function() {
		      ...
		      function resultJson1(data){
		    	  for (var i =0; i<data.length; i++){
		    		  console.log(data[i].i_seq);
		    		
		    			$('#like'+data[i].i_seq).find("#Layer_1").css({ fill: 'pink' }); 
		  ...
		  function resultJson(data){
				  ...
				  console.log("삭제완료");
				  $('#like'+data.i_seq).find("#Layer_1").css({ fill: 'black' });
			  }
			  else{
				  console.log("생성완료");
				  console.log(data);
				  $('#like'+data.i_seq).find("#Layer_1").css({ fill: 'pink' }); 
			  }
